...
/* Phone-only chrome. The header is the one rule that has no desktop
   equivalent — fixed, it ate most of the screen on scroll, so on the phone
   page it scrolls away with the content. */
